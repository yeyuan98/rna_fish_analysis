...
rule integration_qcPlot:
    """
        getting the QC plots
        this rule is responsible for generating all plots in the qcPlots folder.
        merged.pdf -> count plot of all samples
        batch.qc.pdf -> count plot of all samples, faceted by batch
    """
    input:
    ...
    conda:
        "../envs/plot.yaml"
    script:
        "../scripts/mainflow_integration_qcPlot.R"
